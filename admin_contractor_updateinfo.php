...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" href="admin_contractor_updateinfo/css/reset.css"> <!-- CSS reset -->
		<link rel="stylesheet" href="admin_contractor_updateinfo/css/style.css"> <!-- Gem style -->
		<link rel="stylesheet" href="admin_contractor_updateinfo/css/site_info_css.css">
		<script src="js/modernizr.js"></script> <!-- Modernizr -->
	    <!--<link rel="stylesheet" href="css/style.css"> <!-- CSS reset -->
		<script type="text/javascript" src="admin_contractor_updateinfo/js/jquery.cycle.all.js"></script> 
		...
		$_SESSION['site_name']=$site_name;
           ...
           if( empty($site_name))
	          ...
	          {    
		         ...
		         $_SESSION['USERNAME']=$row['site_name'];
